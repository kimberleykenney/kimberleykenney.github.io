...
**Why this piece was created:** The original wallet setup article covers the correct task, but the workflow involves multiple systems, verification steps, and app switching. This sample demonstrates both content evaluation and rewriting for usability.

**Note:** This rewritten sample is based on publicly available information and reasonable product assumptions. Image placement, UI labels, and related links are representational.
...
#### App switching is not clearly guided
...
#### Steps combine multiple actions or assume context
...
#### Platform-specific flows are separated but not strongly signposted
...
#### Screenshots are not fully integrated into the instructions
...
#### Troubleshooting is too general
